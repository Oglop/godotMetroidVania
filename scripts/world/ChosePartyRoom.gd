...
func _updateInterface() -> void:
	...
	if state == ROOM_STATES.CHOOSE_THIRD_MEMBER:
		...
		$CanvasLayer/lblOption5.text = LanguageHandler.getText("lbl_empty")
		$CanvasLayer/lblOption6.text = LanguageHandler.getText("lbl_empty")
		_viewPartyFromSelection(3)
		$CanvasLayer/Selector.show()
	if state == ROOM_STATES.SELECTED_FIRST_OPTION || state == ROOM_STATES.SELECTED_SECOND_OPTION|| state == ROOM_STATES.SELECTED_THIRD_OPTION:
		$CanvasLayer/lblHeader.text = LanguageHandler.getText("lblHeader_Inn")
		$CanvasLayer/lblDescription.text = LanguageHandler.getText("lbl_empty")
		$CanvasLayer/lblOption1.text = LanguageHandler.getText("lbl_empty")
		$CanvasLayer/lblOption2.text = LanguageHandler.getText("lbl_empty")
...
func _physics_process(delta):
	if state != ROOM_STATES.ROOM_ENTERED && state != ROOM_STATES.SELECTED_NO && state != ROOM_STATES.SELECTED_YES && state != ROOM_STATES.SELECTED_FIRST_OPTION && state != ROOM_STATES.SELECTED_SECOND_OPTION && state != ROOM_STATES.SELECTED_THIRD_OPTION:
